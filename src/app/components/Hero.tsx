...
export function Hero() {
  return (
    <section id="home" className="bg-gradient-to-br from-pink-50 to-red-50 py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div className="space-y-6">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-gray-900">
              Beautiful Custom Bucket for{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-pink-500">
                Every Special Moment
              </span>
            </h1>
            <p className="text-lg md:text-xl text-gray-600">
              Handcrafted bucket arrangements for gifts, graduation, birthdays and special occasions.
            </p>
          ...
          <div className="relative">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              <ImageWithFallback
                ...
                alt="Beautiful bucket flower arrangement"
